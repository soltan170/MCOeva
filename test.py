...
def main():       
    ...
    <h1 style ="color:black;text-align:center;">Lockdown Effectiveness Prediction</h1> 
    </div> 
    """
    ...
    <style>
    body {
    background-image: url("https://preview.colorlib.com/theme/covid/images/illustration.png");
